...
function gameLoop(state) {
  ...
  // if the last 50 frames of the letter buffer are the same, then that's an agreed letter
  ...
  if(last_agreed == '.') {
      return true; // means the game is done
  }

  // reset all player velocities to 0 so that user must hold down the key to move
